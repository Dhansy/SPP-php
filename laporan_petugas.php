	...
	<div class="container">
		<div class="clearfixs">
			<div class="float-left">
				<a href="dashboard_petugas.php" id="tambah" class="btn btn-primary shadow">Kembali</a>
			</div>
		</div>
		<div class="text-center mt-2">
			<table class="table table-bordered shadow" border="1">
				...
				$query = "SELECT siswa.nisn, siswa.nama, kelas.nama_kelas, kelas.jurusan , pembayaran.tahun, pembayaran.ket, petugas.id_petugas
				FROM pembayaran
				INNER JOIN petugas ON petugas.id_petugas = petugas.id_petugas
				INNER JOIN siswa ON siswa.nisn = pembayaran.nisn
				INNER JOIN kelas ON kelas.id_kelas = siswa.id_kelas
				WHERE pembayaran.ket = 'lunas'";
